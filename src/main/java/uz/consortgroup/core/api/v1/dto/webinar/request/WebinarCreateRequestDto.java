...
public class WebinarCreateRequestDto {
    ...
    @Schema(description = "Заголовок вебинара", example = "Введение в Spring Boot", maxLength = 100)
    private String title;

    @NotNull(message = "Category required")
    @Size(max = 100, message = "Category must not exceed 100 characters")
    @Schema(description = "Категория вебинара", example = "Java", maxLength = 100)
    ...
    @Schema(description = "URL платформы", maxLength = 255)
    private String platformUrl;

    @NotNull(message = "Course ID is required")
    @Schema(description = "ID курса", pattern = UUID_PATTERN_SCHEMA)
    ...
    @ArraySchema(arraySchema = @Schema(description = "Участники вебинара"))
